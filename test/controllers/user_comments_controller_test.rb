...
class UserCommentsControllerTest < ActionController::TestCase
  ...
  test "should create user_comment" do
    assert_difference('UserComment.count') do
      post :create, user_comment: { content: @user_comment.content, status_id: @user_comment.status_id, user_id: @user_comment.user_id }
    end
  ...
  test "should update user_comment" do
    patch :update, id: @user_comment, user_comment: { content: @user_comment.content, status_id: @user_comment.status_id, user_id: @user_comment.user_id }
    assert_redirected_to user_comment_path(assigns(:user_comment))
  end
